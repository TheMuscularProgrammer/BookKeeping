...
def main():
    ...
    # יצירת consumer אחד שמאזין לכל 3 ה-topics
    ...
    try:
        while True:
            # Poll from all topics with single consumer
