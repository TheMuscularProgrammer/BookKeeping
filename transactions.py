...
@transactions_bp.route('/account/<account_id>/deposit', methods=['POST'])
...
@transactions_bp.route('/account/<account_id>/withdraw', methods=['POST'])
@jwt_required_with_user_id
        ...
        try:
            ...
            if account.balance_cents < amount:
                return jsonify({"error": "Insufficient funds", 
                              "current_balance": account.balance_cents}), 400
...
@transactions_bp.route('/account/<from_account_id>/transfer', methods=['POST'])
@jwt_required_with_user_id
...
@transactions_bp.route('/account/<account_id>/transactions', methods=['GET'])
@jwt_required_with_user_id
